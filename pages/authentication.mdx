...
<Tip>
  **Chave de API**: Sua credencial de acesso à API da AbacatePay. Esta chave identifica sua conta e autoriza suas requisições.
</Tip>
...
<Card title="Ambientes e Chaves de API" icon="book" horizontal>
  ...
  - Chaves criadas em **dev mode** funcionam apenas no ambiente de testes
  - Chaves criadas em **produção** funcionam apenas com dados reais
