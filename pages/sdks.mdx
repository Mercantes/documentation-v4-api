---
title: 'SDKs'
description: 'Bibliotecas oficiais para integração com a API da V4Pay'
icon: 'boxes-stacked'
---
...
Os SDKs (Software Development Kits) da V4Pay são bibliotecas que simplificam a comunicação com nossa API. Eles oferecem uma interface amigável e específica para cada linguagem, permitindo que você integre rapidamente nossos serviços de pagamento ao seu aplicativo.
...
<Tabs>
  <Tab title="Backend">
    <CardGroup cols={2}>
      <Card title="Node.js" icon="node-js" color="#68A063" href="https://github.com/V4Pay/v4pay-nodejs-sdk">
        SDK oficial para Node.js, compatível com TypeScript e ES modules.
      </Card>
      <Card title="Python" icon="python" color="#366B98" href="https://github.com/V4Pay/v4pay-python-sdk">
        SDK oficial para Python 3.6+, com suporte a async/await e type hints.
      </Card>
      <Card title="Java" icon="java" color="#E76F00" href="https://github.com/V4Pay/v4pay-java-sdk">
        SDK oficial para Java 8+, compatível com Spring Boot e Jakarta EE.
      </Card>
      <Card title="PHP" icon="php" color="#777BB3" href="https://github.com/V4Pay/v4pay-php-sdk">
        SDK oficial para PHP 7.4+, com suporte a Composer e PSR standards.
      </Card>
      <Card title="Ruby" icon="gem" color="#CC342D" href="https://github.com/V4Pay/v4pay-ruby-sdk">
        SDK oficial para Ruby 2.6+, disponível como gem e com suporte a Rails.
      </Card>
      <Card title="Go" icon="golang" color="#00ADD8" href="https://github.com/V4Pay/v4pay-go-sdk">
        SDK oficial para Go 1.13+, com suporte a módulos e generics.
      </Card>
      <Card title="Rust" icon="rust" color="#DEA584" href="https://github.com/V4Pay/v4pay-rust-sdk">
        SDK oficial para Rust, com foco em segurança e performance.
      </Card>
      <Card title="Elixir" icon="elixir" color="#6E4A7E" href="https://github.com/V4Pay/v4pay-elixir-sdk">
  ...
  <Tab title="Mobile">
    <CardGroup cols={2}>
      <Card title="Kotlin" icon="android" color="#7F52FF" href="https://github.com/V4Pay/v4pay-kotlin-sdk">
        SDK oficial para Kotlin, ideal para aplicativos Android modernos.
      </Card>
      <Card title="Swift" icon="apple" color="#F05138" href="https://github.com/V4Pay/v4pay-swift-sdk">
...
<CodeGroup>
```javascript Node.js
// Instalação: npm install v4pay-nodejs-sdk
import V4Pay from 'v4pay-nodejs-sdk';

// Inicialize o cliente com sua chave de API
const v4 = V4Pay('your_api_key');

// Crie um pagamento PIX
async function createPixPayment() {
  const billing = await v4.billing.create({
    frequency: "ONE_TIME",
    methods: ["PIX"],
    products: [
      {
...
```python Python
# Instalação: pip install v4pay
from v4pay import V4Pay
from v4pay.products import Product
...
```php PHP
// Instalação: composer require v4pay/sdk
<?php
...
<Accordion title="Falta um SDK para a linguagem que eu uso. O que fazer?">
  Entre em contato conosco em <Icon icon="envelope" type="solid"/> ajuda@v4pay.com informando qual linguagem você precisa. Também aceitamos contribuições da comunidade!
</Accordion>
...
<Card title="Precisa de ajuda com integração?" icon="headset" color="#25c2a0">
  Nossa equipe está disponível para ajudar com qualquer dúvida sobre nossos SDKs. Entre em contato pelo e-mail <Icon icon="envelope" type="solid"/> ajuda@v4pay.com
</Card>
