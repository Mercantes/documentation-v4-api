  ...
  <Step title="Acesse a Seção de Webhooks">
    <Card>
      <img
        ...
        alt="Interface da plataforma V4Pay mostrando a seção de webhooks"
      />
...
```
https://meusite.com/webhook/v4pay
```

URL com secret (como será chamado):
```
https://meusite.com/webhook/v4pay?webhookSecret=seu_secret_aqui
```
